...
export const vaultFundingFeeHistoryTablecolumns: ColumnDef<PoolManageWrapper>[] = [
  {
    accessorKey: 'name',
    header: () => '金库',
    cell: ({ row }) => {
...
export const VaultFundingFeeHistoryRecords = () => {
  ...
  const table = useReactTable({
    data,
    columns: vaultFundingFeeHistoryTablecolumns,
