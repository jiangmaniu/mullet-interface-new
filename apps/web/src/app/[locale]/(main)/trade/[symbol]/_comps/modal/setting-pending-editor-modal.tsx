...
const SettingPendingEditorModalContent = observer(
  ({ pendingOrderInfo, onConfirm, onClose }: SettingPendingEditorModalContentProps) => {
    ...
    const { setSl, setSp, slFlag, spFlag, takeProfit, stopLoss, orderPrice, setOrderPrice, disabledBtnByCondition } =
      useTrade({
