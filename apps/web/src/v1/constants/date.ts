...
export const DATE = {
  ...
  DATE_2_MONTHS_AFTER: moment().add(2, 'months').format('YYYY-MM-DD'),
  DATE_1_MONTHS_AFTER: moment().add(1, 'months').format('YYYY-MM-DD'),
  DATE_1_WEEK_AFTER: moment().add(1, 'weeks').format('YYYY-MM-DD'),
