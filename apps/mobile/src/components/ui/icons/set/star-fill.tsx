...
const StarFill = ({ width, height, viewBox, color, ...props }: SvgProps) => (
  <Svg width={width ?? 22} height={height ?? 22} viewBox={viewBox ?? "0 0 22 22"} fill="none" {...props}>
    <Path
...
export const IconStarFill = withUniwind(StarFill)