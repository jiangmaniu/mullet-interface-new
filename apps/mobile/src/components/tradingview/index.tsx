  ...
  useEffect(() => {
    if (mode === 'simple' && resolution && isReady) {
      webviewRef.current?.postMessage(
        JSON.stringify({
          payload: { type: BridgeIncoming.ActiveChart, method: 'setResolution', args: [resolution] },
        }),
      )
    }
  }, [mode, resolution, isReady])
