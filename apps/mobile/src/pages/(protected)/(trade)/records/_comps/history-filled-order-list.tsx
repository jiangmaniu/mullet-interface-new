...
import { getTradeRecordsPage } from '@/services/tradeCore/order'
...
const FilledOrderCard = ({ order }: { order: Order.TradeRecordsPageListItem }) => {
...
export const HistoryFilledOrderList = () => {
