...
export const WithdrawalList = ({ accountSelector }: { accountSelector: React.ReactNode }) => {
...
// 提现卡片组件
const WithdrawalCard = ({ record, account }: { record: MoneyTransferVO; account: User.AccountItem | undefined }) => {
