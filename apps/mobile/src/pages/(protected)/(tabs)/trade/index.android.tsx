...
import { TradePendingOrders } from './_comps/records/pending-orders/index.android'
import { TradePositions } from './_comps/records/positions/index.android'
import { SymbolChartView } from './_comps/symbol-chart-view.android'
...
const Trade = () => {
  ...
  const scrollViewInnerRef = useCallback((ref: any) => {
