// import { useHeaderTabContext } from '@mullet/react-native-tabs'
...
export type TabFlashListProps<T> = Omit<FlashListProps<T>, 'renderScrollComponent'> & {
  index: number
}

function TabFlashListComponent<T>(props: TabFlashListProps<T>, ref: React.Ref<any>) {
