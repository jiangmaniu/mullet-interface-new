...
export type CollapsibleHeaderProps<T extends Route> = {
  ...
  emptyBodyComponent?: ReactElement | null;
  renderSceneHeader?: (props: T) => ReactElement | null;
  /**
...
export type TabViewCustomRenders = {
  ...
  renderTabBarContainer: (children: any) => ReactElement;
  // biome-ignore lint/suspicious/noExplicitAny: <explanation>
  renderSceneHeader: (children: any, props: any) => ReactElement;
};
...
> &
  CollapsibleHeaderProps<T> & {
    initialPage: number;
    renderTabView: (e: TabViewCustomRenders) => ReactElement;
  };
